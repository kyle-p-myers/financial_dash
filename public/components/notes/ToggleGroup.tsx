...
export default function ToggleGroup() {
  ...
  >
    ...
    <Toolbar.Button
      className="px-[14px] text-white bg-violet-500 flex-shrink-0 flex-grow-0 basis-auto h-[32px] rounded inline-flex text-[13px] leading-none items-center justify-center outline-none hover:bg-violet10 focus:relative focus:shadow-[0_0_0_2px] focus:shadow-violet7"
